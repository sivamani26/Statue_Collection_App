...
<BsDashLg className="grip-icon" />
          ...
          >
            ...
            >
              ...
              {/* Likes and DisLikes */}
              <Box display="flex" alignItems="center" className="IconButtons">
              ...
              <div className="additional-info">
                ...
                <Collapse in={showDescription} collapsedSize={50}>
                  <Typography variant="body1" className="dis_details">
                    ...
                    own enlightenment to assist others in their spiritual
                    journey. The concept of Maitreya as a future Buddha is found
                    in various Buddhist scriptures and sutras, including the
                    Digha Nikaya, which is one of the collections of Buddhist
                    texts known as the "Long Discourses" or "Long Sayings." In
                    these texts, it is mentioned that Maitreya will succeed the
                    current Buddha, Siddhartha Gautama (also known as Shakyamuni
                    Buddha), as the next enlightened teacher of humanity.
                    According to the Buddhist tradition, there are seven
                    historical Buddhas who have already appeared in the world
                    before Siddhartha Gautama, and Maitreya is regarded as the
                    eighth and final Buddha of this era The Digha Nikaya also
                    specifies that Maitreya Buddha will be born in Ketumati, a
                    city in present-day Varanasi, Uttar Pradesh, India. When the
                    time is right, Maitreya will descend from the Tushita heaven
                    to be reborn on Earth and begin his final life as a human
                    being. During this time, Maitreya will teach the Dharma (the
                    teachings of Buddhism) and lead countless beings toward
                    enlightenment. In Buddhist art and iconography, Maitreya is
                    often depicted as a bodhisattva wearing ornate jewelry,
                    including earrings, wristlets, necklaces, and an amulet.
                    This symbolism represents his position as a bodhisattva,
                    someone who has acquired great merit and wisdom through
                    countless lifetimes and has chosen to remain in the cycle of
                    rebirth to help all beings achieve liberation from
                    suffering. The idea of Maitreya as the future Buddha serves
                    as a source of hope and inspiration for Buddhists, as it
                    signifies the continuation of the Buddha's teachings and the
                    potential for enlightenment for all beings in the future.
                    However, it is essential to note that beliefs and
